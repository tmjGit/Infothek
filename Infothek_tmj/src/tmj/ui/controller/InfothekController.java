...
import tmj.ui.controls.ObjectCombobox;
import tmj.ui.lang.Language;
import tmj.ui.lang.Localization;

public class InfothekController implements Initializable {
...
//	private static final String[] FIELDS = new String[]{"id" ,"vorname" ,"nachname" ,"plz" ,"ort" ,"strasse" ,"telefon" ,"mobil" ,"email" };
	...
	private static final DateTimeFormatter DATETIME_FORMAT=DateTimeFormatter.ofPattern(Application.confMainGet("datetimeformat"));
